...
with open('metric-template.txt') as f:
    ...
    while(True):
        ...
        metric_template = metric_template.replace("#cpu_user#", str(cpu_user))
        metric_template = metric_template.replace("#cpu_system#", str(cpu_system))
        metric_template = metric_template.replace("#cpu_idle#", str(cpu_idle))
        metric_template = metric_template.replace("#mem_available#", str(mem_available))
